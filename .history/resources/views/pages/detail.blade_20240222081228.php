            ...
            <div class="col-md-4 p-0">
                <div class="position-sticky mt-3 bg-body-tertiary p-4" style="top: 1rem;">
                    ...
                    <div class="py-4 mb-3 bg-body-tertiary rounded">
                        ...
                        <ul class="list-unstyled">
                            <div class="col-lg-8">
                                <h5 class="mb-0 mt-1">Judul    :{{ $film->judul }}</h5>
                                <h5 class="mb-0 mt-1">Dibuat   :{{ $film->created_at->format('F j, Y') }}</h5>
                                <h5 class="mb-0 mt-1">Kategori :{{ $film->kategori->nama_kategori }}</h5>
                            </div>
                        </ul>
                    </div>
                </div>
