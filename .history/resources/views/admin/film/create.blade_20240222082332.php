    ...
    <div class="container my-4">
        <div class="card">
            <div class="card-header">
                <h5 class="fw-bold my-auto">Tambahkan fil</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('fil.perform') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="kategori_id" id="kategoriSelect">
                                            <option selected="" value="">pilih kategori fil</option>
