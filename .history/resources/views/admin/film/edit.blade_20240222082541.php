...
@section('content')
    <div class="container my-4">
        <form action="{{ route('fil.update', $fil->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="namaJudul" class="form-label">Judul fil</label>
                                <input type="text" name="judul" class="form-control" value="{{ $fil->judul }}"
                                    id="namaJudul">
                                @error('judul')
                            ...
                            <div class="mb-3">
                                ...
                                <div id="isi" style="height:350px;">{!! $fil->isi !!}</div>
                                <textarea class="form-control" name="isi" id="content-textarea" hidden style="display: none;">{!! $fil->isi !!}</textarea>
                                @error('isi')
                                    <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            </div>
                ...
                <div class="col-md-3">
                            ...
                            <div class="mb-3">
                                <div class="card shadow-none border text-center ">
                                    <label class="form-label border-dashed cursor-pointer" id="label"
                                        ...
                                        <img src="{{ asset('img/gambar/' . $fil->gambar) }}" id="plusimg"
                                            class="img-fluid p-md-3" alt="">
                                        <input accept="image/*" type="file" name="gambar" value="{{ $fil->gambar }}"
                    ...
                    <div class="text-end">
                        <a href="/fil" class="btn btn-secondary">Cancel</a>
